    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <div class="panel panel-default"><!-- panel panel-default begin -->
          ...
          $vendor_session= $_SESSION['vendor_email'];
           ...
           $get_ven = "select * from vendors where vendor_email='$vendor_session'";
            
            $run_ven = mysqli_query($con,$get_vendor);
            
            $row_ven = mysqli_fetch_array($run_vendor);
            
            $ven_id = $row_ven['vendor_id'];   
          
                                $i=0;
                            
                                $get_orders = "SELECT * FROM `pending_orders` WHERE `vendor_id`='$ven_id'";
