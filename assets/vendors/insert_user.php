               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="vendor_country" type="text" class="form-control" required>
...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into vendors (vendor_name,vendor_email,vendor_pass,vendor_country,vendor_contact,vendor_job,vendor_image,vendor_about) values ('$user_name','$user_email','$user_pass','$user_country','$user_contact','$user_job','$user_image','$user_about')";
