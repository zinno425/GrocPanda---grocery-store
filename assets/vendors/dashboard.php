        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img src="vendor_images/<?php echo $vendor_image; ?>" alt="<?php echo $vendor_image; ?>" class="rounded img-responsive">
                    
                    <div class="thumb-info-title"><!-- thumb-info-title begin -->
                       
                        <span class="thumb-info-inner"> <?php echo $vendor_name; ?> </span>
                        <span class="thumb-info-type"> <?php echo $vendor_job; ?> </span>
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        ...
                        <i class="fa fa-flag"></i> <span> State: </span> <?php echo $vendor_state; ?> <br/>
