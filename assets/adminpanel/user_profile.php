...
if(isset($_POST['update'])){
    ...
    $update_vendor = "update admins set admin_name='$vendor_name',admin_email='$vendor_email',admin_pass='$vendor_pass',admin_country='$vendor_country',admin_contact='$vendor_contact',admin_job='$vendor_job',admin_about='$vendor_about',admin_image='$vendor_image' where admin_id='$vendor_id'";
