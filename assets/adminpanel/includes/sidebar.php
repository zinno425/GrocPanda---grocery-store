    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse begin -->
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
               ...
               <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#brands"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-info"></i> Brands
                        <i class="fa fa-fw fa-caret-down"></i>
                        
                </a><!-- a href finish -->
                
                <ul id="brands" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
            ...
            <li><!-- li begin -->
             ...
             <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#orders"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-info"></i> View orders
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="orders" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?view_orders"> Pendind Orders </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_total_orders"> Orders </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
               ...
               <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#panda"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-users"></i> Panda penny service
                        <i class="fa fa-fw fa-caret-down"></i>
                        
                </a><!-- a href finish -->
                
                <ul id="panda" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?customer_panel"> View Customer panel </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_history"> View Trxn history </a>
                    </li><!-- li finish -->
                       ...
                       <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#vendor"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-users"></i> Vendors
                        <i class="fa fa-fw fa-caret-down"></i>
                        
                </a><!-- a href finish -->
                
                <ul id="vendor" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_vendor"> Insert Vendors </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_vendor"> View Vendors </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?vendor_profile=<?php echo $vendor_id; ?>"> Edit Vendors Profile </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
